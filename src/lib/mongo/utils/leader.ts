...
export interface LeaderOptions {
  ...
  groupName?: string
  /** Lock time to live in milliseconds. Default and minimum: 1000 */
  ttl?: number
  /** Time between tries getting elected in milliseconds. Default and minimum: 500 */
  wait?: number
}
...
export class Leader extends EventEmitter {
   ...
   * @returns {Promise<boolean>} True if this instance is the current leader
   */
  async isLeader() {
  ...
  /**
   * Attempts to elect this instance as the leader
